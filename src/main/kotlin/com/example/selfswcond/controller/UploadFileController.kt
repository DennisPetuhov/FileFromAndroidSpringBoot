package com.example.selfswcond.controller

import com.example.selfswcond.data.Response
...
class UploadFileController {
    ...
    @Operation(summary = "загружаем файл")
    fun uploadFile(@Parameter(description = "файл")
                   @RequestParam("file") file: MultipartFile): ResponseEntity<Response> {
